...
You can can either go into the Support forum, or in the [Tiny Bootstrap Repository](https://github.com//tiny-bootstrap).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//tiny-bootstrap)
(See above as well.)
...
3. type `git clone git@github.com:/tiny-bootstrap.git`
...
Either post it on the [GitHub-repo](https://github.com//tiny-bootstrap) or—if you cloned the repository—send me a pull request.
